...
class StsEsqueceuSenha
{
    ...
    public function esqueceuSenha(array $Dados)
    {
        ...
        if ($this->Resultado) {
            ...
            $esqSenha->fullRead("SELECT id, nome, usuario, recuperar_senha FROM sts_usuarios WHERE email =:email LIMIT :limit", "email={$this->Dados['email']}&limit=1");
    ...
    private function dadosEmail()
    {
        ...
        $this->DadosEmail['cont_email'] .= "<a href='" . URL . "atual-senha/atual-senha?chave=" . $this->DadosUsuario[0]['recuperar_senha'] . "'>Clique aqui</a><br><br>";
        ...
        $this->DadosEmail['cont_text_email'] = "Olá " . $prim_nome . " Você solicitou uma alteração de senha. Seguindo o link abaixo você poderá alterar sua senha. Para continuar o processo de recuperação de sua senha, clique no link abaixo ou cole o endereço abaixo no seu navegador. " . URL . "atual-senha/atual-senha?chave=" . $this->DadosUsuario[0]['recuperar_senha'] . " Usuário: " . $this->DadosUsuario[0]['usuario'] . "Se você não solicitou essa alteração, nenhuma ação é necessária. Sua senha permanecerá a mesma até que você ative este código.";
