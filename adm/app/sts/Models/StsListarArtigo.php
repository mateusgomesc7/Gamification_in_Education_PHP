...
class StsListarArtigo
{
    ...
    public function listarArtigo($PageId = null)
    {
        ...
        $paginacao->paginacao("SELECT COUNT(id) AS num_result FROM sts_perguntas");
        ...
        $listarArtigo->fullRead("SELECT art.id, art.titulo, 
                ...
                sit.nome nome_sit,
                cr.cor cor_cr
                FROM sts_perguntas art 
                INNER JOIN sts_cats_perguntas cat ON cat.id=art.sts_cats_artigo_id
